...
[![Build Status](https://img.shields.io/badge/Verification-26%2F26%20PASSED%20(100%25)-00ff66?style=for-the-badge&logo=checkmarx&logoColor=black)](https://github.com/amit-dev01/Chain-Sleuth-Backend)
[![Python Version](https://img.shields.io/badge/Python-3.12%20%7C%203.14-blue?style=for-the-badge&logo=python&logoColor=white)](https://python.org)
...
[![Neo4j AuraDB](https://img.shields.io/badge/Graph_DB-Neo4j%20AuraDB-008CC1?style=for-the-badge&logo=neo4j&logoColor=white)](https://neo4j.com)
[![Auth0 RS256](https://img.shields.io/badge/Zero--Trust-Auth0%20RS256%20RBAC-EB5424?style=for-the-badge&logo=auth0&logoColor=white)](https://auth0.com)
[![AI/ML Powered](https://img.shields.io/badge/AI%2FML-GraphSAGE%20%2B%20XGBoost%20%2B%20Gemini-FF6F00?style=for-the-badge&logo=pytorch&logoColor=white)](https://onnxruntime.ai/)
[![OFAC Realtime](https://img.shields.io/badge/Sanctions-OFAC%20SDN%20Dragnet-critical?style=for-the-badge&logo=shield&logoColor=white)](https://sanctionssearch.ofac.treas.gov/)
[![Legal Compliance](https://img.shields.io/badge/Statutory-BNSS%20%C2%A794%20%7C%20BSA%20%C2%A763%20%7C%20PMLA-red?style=for-the-badge&logo=law&logoColor=white)](https://prsindia.org)
...
```mermaid
flowchart LR
    A[Suspicious Address] --> B[Feature Extraction\n50 Sub-graph Features]
    B --> C[1. GraphSAGE GNN\nONNX Topological Risk]
    B --> D[2. XGBoost Ensemble\n4 Adversarial Typologies]
    B --> E[3. Isolation Forest\nUnsupervised Anomaly Index]
    B --> F[4. Hard Forensics\nOFAC / Blacklists / Rules]
    C --> G[5. Multi-Signal Ensemble Scorer\nCalibrated 0-100 Risk Rating]
    D --> G
    E --> G
    F --> G
    G --> H[Gemini 2.0 Flash\nStatutory Legal Report Generator]
    H --> I[Digital Judicial Docket\nSection 94 BNSS + Section 63 BSA]
```
